...
productMenu.copyProductsToGroup = function (groupId) {
    ...
    var copyProducts = function () {
        new Ajax.Request("/Admin/Module/eCom_Catalog/dw7/Edit/EcomUpdator.aspx?CMD=ProductList.CopyProducts&ToGroupID=" + groupId + "&prodCollection=" + selectedValues + "&copyGroupRelation=" + this._pcm, {
            method: 'get',
    ...
    if (this._pcm) {
        new Ajax.Request("/Admin/Module/eCom_Catalog/dw7/Edit/EcomUpdator.aspx?CMD=ProductList.CopyProductsWithCkeck&ToGroupID=" + groupId + "&FromGroupId=" + this._groupId + "&prodCollection=" + selectedValues + "&copyGroupRelation=" + this._pcm, {
            method: 'get',
            onSuccess: function (transport) {
                if (transport.responseText == "true") {
                    alert(productMenu._successCopyMessage);
