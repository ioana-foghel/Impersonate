    ...
    <script>
        ...
        function initFieldsBulkEditPage(opts) {
            ...
            var obj = {
                ...
                cancel: function () {
                    Dynamicweb.PIM.BulkEdit.get_current().navigateToProduct("", options.productId);
                },
                save: function (saveAndClose) {
                    ...
                    var msg = Action.Transform(options.labels.confirmSaveMessage, { "productId": options.productId, "fields": fieldsListStr })
