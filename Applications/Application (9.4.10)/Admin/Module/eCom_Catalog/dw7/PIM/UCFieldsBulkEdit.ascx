...
<dwc:GroupBox runat="server" ID="VariantsTreeGroupbox" Visible="False">
    <table class="formsTable">
        <tr>
            ...
            <td>
                <div id="VariantsTree" runat="server" class="variant-selection-tree"></div>
            </td>
        </tr>
    </table>
</dwc:GroupBox>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-CssClass="multi-edit-field-selector-column">
                            <ItemTemplate>
                                ...
                                <dwc:SelectPicker Multiple="True" runat="server" ID="MultiSelectListFieldEditor" />
                                <dwc:SelectPicker runat="server" ID="RadioButtonListFieldEditor" />
                                <dwc:SelectPicker Multiple="True" runat="server" ID="CheckBoxListFieldEditor" />
