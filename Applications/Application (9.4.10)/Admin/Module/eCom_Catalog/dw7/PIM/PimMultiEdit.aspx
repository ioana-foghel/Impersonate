...
<asp:Content ID="Main" ContentPlaceHolderID="ContentHolder" runat="server">
    ...
    <dw:Dialog runat="server" ID="MultiEditDlg" Title="Multiple fields edit" ShowOkButton="true" Size="large" ShowCancelButton="true" ShowClose="true" OkAction="Dynamicweb.PIM.BulkEdit.get_current().updateFields();">
