                    ...
                    <dwc:GroupBox ID="gbSettings" runat="server" DoTranslation="true" Title="Database">
                        <table class="formsTable">
                            ...
                            <%--<tr id="access_1">
                                ...
                                <td>
                                    <dw:FileManager runat="server" Name="csLocalPath" ID="csLocalPath" Extensions="mdb" Folder="Files/" ShowPreview="false"
                                        CssClass="NewUIinput" FullPath="true" ShowOnlyAllowedExtensions="True" />
                                </td>
                            </tr>--%>
                        </table>
                    </dwc:GroupBox>
