      ...
      <li>
        <xsl:attribute name="class">
          ...
          <xsl:if test="count(Page) and /NavigationTree/Settings/LayoutNavigationSettings/@endlevel > @RelativeLevel">
            ...
            <xsl:if test="@InPath='False'"> menu-mobile__item--closed </xsl:if>
            <xsl:if test="@InPath='True'"> menu-mobile__item--open </xsl:if>
          </xsl:if>
        </xsl:attribute>
        <a>
          <xsl:attribute name="class">
            ...
            <xsl:if test="count(Page) and /NavigationTree/Settings/LayoutNavigationSettings/@endlevel > @RelativeLevel">
              <xsl:if test="@InPath='False'"> menu-mobile__link--closed </xsl:if>
              <xsl:if test="@InPath='True'"> menu-mobile__link--open </xsl:if>
            </xsl:if>
          </xsl:attribute>
